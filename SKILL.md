...
**Creating STI instances in controllers** — per Critical Rule 14 (exhaustive switch on closed enums), the `create` action switches on `type` with a `_never` default:
